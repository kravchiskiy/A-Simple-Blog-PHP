<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/templates/admin/head.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/templates/admin/header.php';
?>
...
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light  collapse">
            <div class="position-sticky pt-3 sidebar-sticky">
                ...
                <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted text-uppercase">
                    ...
                    <a class="link-secondary" href="https://getbootstrap.com/docs/5.2/examples/dashboard/#"
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <!--            <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="2073" height="875"-->
            <!--                    style="display: block; width: 2073px; height: 875px;"></canvas>-->
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" class="form-control" id="exampleFormControlTextarea1"
                              rows="3"><?= $article['content'] ?></textarea>
                </div>
                <div class="form-inline">
                    ...
                    <select name="categoryId" class="custom-select my-1 mr-sm-2" id="categoryId">
                        <option value="0">Choose...</option>
                        <?php while ($row = $articleCategory->fetch()): ?>
                            <option value="<?= $row['id'] ?>"
                                    <?php if ($article['categoryId'] == $row['id']): ?>selected <?php endif; ?> ><?= $row['name'] ?></option>
                        <?php endwhile; ?>
                    </select>
...
<!--                <div class="form-inline">-->
                    <div class="custom-control custom-checkbox ">
                        <input type="checkbox" class="custom-control-input" name="isPublished" id="customCheck1" value="1"  <?php if ($article['isPublished']): ?>checked <?php endif; ?>>
                        <label class="custom-control-label" for="customCheck1">Published</label>
                    </div>
<!--                </div>-->
                <button class="btn btn-primary w-100 mt-4 py-2" type="submit">Edit</button>
...
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/templates/admin/footer.php';
?>