...
<!--                        <th scope="col">Header</th>-->
                    ...
                    <?php while($row = $articles->fetch()):?>
                        <tr>
                            <td><?= $row['id']?></td>
                            <td><?= $row['title']?></td>
                            <td><img width="250" src="/images/<?= $row['img']?>" alt=""></td>
                            <td><?php if($row['isPublished']){?> Yes <?php }else{?> No<?php }?></td>
                            <td><?= $row['createdAt']?></td>
                            <td>
                                <a href="/admin/?act=edit&id=<?= $row['id'] ?>" class="btn btn-primary">Edit</a>
                                <a href="/admin/?act=delete&id=<?= $row['id'] ?>" class="btn btn-danger">Delete</a></td>
                        </tr>
                    <?php endwhile;?>
                    </tbody>
                </table>
