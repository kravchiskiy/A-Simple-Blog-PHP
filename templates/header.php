            ...
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4"><h4>About</h4>
                    <p class="text-body-secondary">Add some information about the album below, the author, or any other
                        ...
                        Then, link them off to some social networking sites or contact information.</p></div>
                <div class="col-sm-4 offset-md-1 py-4"><h4>Contact</h4>
                    <ul class="list-unstyled">
                        <li><a href="https://getbootstrap.com/docs/5.3/examples/album/#" class="text-white">Follow on
                                X</a></li>
                        <li><a href="https://getbootstrap.com/docs/5.3/examples/album/#" class="text-white">Like on
                                Facebook</a></li>
                        <li><a href="https://getbootstrap.com/docs/5.3/examples/album/#" class="text-white">Email me</a>
                        </li>
                    </ul>
                </div>
            </div>
